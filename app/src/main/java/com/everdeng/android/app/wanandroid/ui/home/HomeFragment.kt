...
class HomeFragment : BaseFragment2<FragmentHomeBinding, HomeViewModel>() {
    ...
    private fun initBanner() {
        val imageList = listOf(
            "http://dingyue.ws.126.net/2019/02/11/7d72ff294f114e6d86f1f6b3a6df83bb.jpeg",
            "http://img.article.pchome.net/game/00/20/19/54/pic_lib/s960x639/120-110330134506s960x639.jpg"
        )
