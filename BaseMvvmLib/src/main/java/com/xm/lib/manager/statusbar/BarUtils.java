package com.xm.lib.manager.statusbar;
...
//        return resources.getDimensionPixelSize(resourceId);
        int statusBarHeight = MeasureManager.getStatusBarHeight(BaseApp.getApp().getApplicationContext());
...
//                layoutParams.topMargin - getStatusBarHeight(),
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = BaseApp.getApp().getSystemService("statusbar");
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = BaseApp.getApp()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        ...
        boolean menu = ViewConfiguration.get(BaseApp.getApp()).hasPermanentMenuKey();
    ...
    private static AppCompatActivity getActivityByView(@NonNull final View view) {
        ...
        Log.e("BarBaseApp", "the view's Context is not an Activity.");
        return null;
    }
}
