...
public class SpanManager {
    ...
    private static SpanManager SpanManager;
    private Builder builder;

    public static synchronized SpanManager getInstance(String text) {
        if (null == SpanManager) {
     ...
     */
    public SpanManager setForegroundColorSpan(int start, int end, @ColorInt int colorId) {
    ...
    public SpanManager setImageSpan(Drawable drawable, int start, int end) {
     ...
     * 设置文本的部分文字背景颜色，
     */
    public SpanManager setBackgroundColorSpan(int start, int end, @ColorInt int colorId) {
     ...
     * 设置文本的部分文字的点击事件
     */
    public SpanManager setClickableSpan(int start, int end, TextView mTextView
     ...
     */
    public SpanManager setEmbossMaskFilter(int start, int end, float[] direction, float ambient, float specular, float blurRadius) {
     ...
     */
    public SpanManager setBlurMaskFilter(int start, int end, int radius) {
     ...
     */
    public SpanManager setRelativeSizeSpan(int start, int end, float proportion) {
     ...
     */
    public SpanManager setAbsoluteSizeSpan(int start, int end, int size, boolean isDip) {
     ...
     */
    public SpanManager setScaleXSpan(int start, int end, float proportion) {
     ...
     * Typeface.STYLE_MASK
     */
    public SpanManager setStyleSpan(int start, int end, int textTypeFace) {
     ...
     */
    public SpanManager setTypefaceSpan(int start, int end, String family) {
     ...
     */
    public SpanManager setTextAppearanceSpan(int start, int end, Context mContext, int styleId) {
     ...
     */
    public SpanManager setUnderlineSpan(int start, int end) {
     ...
     * 设置文字删除线
     */
    public SpanManager setStrikeThroughSpan(int start, int end) {
