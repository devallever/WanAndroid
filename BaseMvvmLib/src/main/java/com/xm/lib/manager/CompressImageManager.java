...
public class CompressImageManager {
    ...
    private static CompressImageManager compressImageManager;
    private static WeakReference<Context> contextWeakReference;
    private int quality = 100;
    private int width = 0;
    private int height = 0;
    private String TAG = CompressImageManager.class.getSimpleName();

    public static CompressImageManager getInstance(Context mContent, OnImageCallBack onImageCallBack) {
     ...
     * 设置图片质量百分比
     */
    public CompressImageManager setQuality(int quality) {
     ...
     * 设置压缩的图片尺寸
     */
    public CompressImageManager setSize(int width, int height) {
        this.width = width;
        this.height = height;
        return this;
    }
